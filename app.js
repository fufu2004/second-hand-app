document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateUIForAuthState() {
        ...
        const installButtonHtml = `
            <button id="install-app-btn" class="flex items-center gap-2 bg-amber-400 text-gray-800 font-bold py-2 px-3 rounded-full shadow-md transition transform hover:scale-105" title="להורדת האפליקציה">
